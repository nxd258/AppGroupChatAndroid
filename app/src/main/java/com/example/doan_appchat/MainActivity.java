...
//                    Toast.makeText(MainActivity.this,"Welcome",Toast.LENGTH_SHORT).show();
    ...
    private void RequestNewGroup() {
        // Tạo một hộp thoại (AlertDialog) để yêu cầu người dùng nhập tên nhóm
        AlertDialog.Builder builder=new AlertDialog.Builder(MainActivity.this,R.style.AlertDialog);
        builder.setTitle("Enter group name: ");
        // Tạo trường nhập liệu cho người dùng nhập tên nhóm
        final EditText groupnamefield=new EditText(MainActivity.this);
        groupnamefield.setHint("e.g. Family members");
        builder.setView(groupnamefield);
        // Thiết lập nút Positive (Create) để xử lý sự kiện khi người dùng nhấn Create
        builder.setPositiveButton("Create", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                // Lấy tên nhóm từ trường nhập liệu
        ...
        // Thiết lập nút Negative (Cancel) để đóng hộp thoại khi người dùng nhấn Cancel
    ...
    private void CreateNewGroup(final String groupname) {
        // Tạo một nhóm mới trong cơ sở dữ liệu Firebase
